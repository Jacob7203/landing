      ...
      <React.Fragment>
        <Helmet>
          ...
          {_.get(this.props, "page.frontmatter.seo.robots", null) && (
            <meta
              name="robots"
              content={_.join(_.get(this.props, "page.frontmatter.seo.robots", null), ",")}
            />
          )}
          ...
          <body
            className={
              "layout-" +
              _.get(this.props, "data.config.layout_type", null) +
              " style-" +
              _.get(this.props, "data.config.style", null) +
              " palette-" +
              _.get(this.props, "data.config.palette", null) +
              " mode-" +
              _.get(this.props, "data.config.mode", null) +
              " font-" +
              _.get(this.props, "data.config.base_font", null)
            }
          />
        </Helmet>
