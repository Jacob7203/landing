            ...
            <div className="navbar__branding mr-2">
              {_.get(this.props, "data.config.header.logo", null) ? (
                <Link className="navbar__logo m-0" href={withPrefix("/")}>
                  <img
                    src={withPrefix(_.get(this.props, "data.config.header.logo", null))}
                  ...
                  <div className="navbar__scroller">
                    <div className="navbar__inner">
                      ...
                      <div className="navbar__menu flex-md">
                        {_.get(this.props, "data.config.header.has_primary_nav", null) &&
                          _.get(this.props, "data.config.header.primary_nav_links", null) && (
                            <HeaderMenu
                              {...this.props}
                              header_menu={_.get(
                                this.props,
                        ...
                        {_.get(this.props, "data.config.header.has_secondary_nav", null) &&
                          _.get(this.props, "data.config.header.secondary_nav_links", null) && (
                            <HeaderMenu
                              {...this.props}
                              header_menu={_.get(
                                this.props,
