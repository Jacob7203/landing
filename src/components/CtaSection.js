              ...
              {has_text && (
                <div
                  className={classNames("cta__body", "my-1", "cell-12", {
                    "cell-md-7": is_horiz && has_actions && actions_width === "fourty",
                    "cell-md-6": is_horiz && has_actions && actions_width === "fifty",
                    "cell-md-5": is_horiz && has_actions && actions_width === "sixty",
              ...
              {has_actions && (
                <div
                  className={classNames("cta__actions", "my-1", "cell-12", {
                    "cell-md-5": is_horiz && has_text && actions_width === "fourty",
                    "cell-md-6": is_horiz && has_text && actions_width === "fifty",
                    "cell-md-7": is_horiz && has_text && actions_width === "sixty",
