            ...
            {has_media && (
              <div
                className={classNames("feature__media", "my-2", "cell-12", {
                  "cell-md-4": is_horiz && has_text && media_width === "thirty-three",
            ...
            {has_text && (
              <div
                className={classNames("feature__body", "my-2", "cell-12", {
                  "cell-md-8": is_horiz && has_media && media_width === "thirty-three",
                  "cell-md-7": is_horiz && has_media && media_width === "fourty",
