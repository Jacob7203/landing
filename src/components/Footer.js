          ...
          {(has_logo ||
            ...
            <div className="site-footer__nav py-5 py-md-6">
              <div className="container">
                <div
                  className={classNames("grid", { "justify-md-center": has_logo === false })}
                >
                  {has_logo && (
                    <Link
                    ...
                    >
                      <img
                        src={withPrefix(_.get(this.props, "data.config.footer.logo", null))}
                        alt={_.get(this.props, "data.config.header.logo_alt", null)}
                      />
                    </Link>
                  )}
                  {_.get(this.props, "data.config.footer.has_primary_nav", null) &&
                    _.get(this.props, "data.config.footer.primary_nav_links", null) && (
                  ...
                  {_.get(this.props, "data.config.footer.has_secondary_nav", null) &&
                    _.get(this.props, "data.config.footer.secondary_nav_links", null) && (
                      <div className="site-footer__menu cell-12 cell-md my-3 my-md-4">
                  ...
                  {_.get(this.props, "data.config.footer.has_tertiary_nav", null) &&
                    _.get(this.props, "data.config.footer.tertiary_nav_links", null) && (
                      <div className="site-footer__menu cell-12 cell-md my-3 my-md-4">
