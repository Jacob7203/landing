                ...
                >
                  <div
                    className={classNames("item__media", {
                      ...
                      "mb-3":
                        image_pos !== "bottom" && has_text && is_card_no_padding === false,
                      "mb-md-0": is_horiz && has_text && is_card_no_padding === false,
                      "ml-md-3":
                        image_pos === "right" && has_text && is_card_no_padding === false,
                      "mr-md-3":
                        image_pos === "left" && has_text && is_card_no_padding === false,
                      "mt-3": image_pos === "bottom" && has_text && is_card_no_padding === false
                    })}
                  >
                    <img
              ...
              {has_text && (
                <div
                  className={classNames({
                    ...
                    "mb-auto": is_card && image_pos === "bottom" && image_has_padding === false
                  })}
                >
                  <div
                    className={classNames("item__body", {
                      ...
                      "pb-sm-4": has_image && is_card_no_padding && image_pos !== "bottom",
                      "pt-sm-4": has_image && is_card_no_padding && image_pos === "bottom",
                      "py-md-4": has_image && is_card_no_padding && is_horiz,
                      "pr-md-4": has_image && is_card_no_padding && image_pos === "left",
                      "pl-md-3": has_image && is_card_no_padding && image_pos === "left",
                      "pl-md-4": has_image && is_card_no_padding && image_pos === "right",
                      "pr-md-3": has_image && is_card_no_padding && image_pos === "right"
                    })}
                  >
                    {_.get(item, "title", null) &&
