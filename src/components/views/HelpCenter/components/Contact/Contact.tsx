    ...
    <div className={className} {...rest}>
      ...
      <List disablePadding className={classes.list}>
        <ListItem disableGutters data-aos="fade-up" className={classes.listItem}>
          <ListItemAvatar>
            <Avatar
              src="https://cdn.watheia.org/assets/illustrations/contact-icon-phone.png"
              srcSet="https://cdn.watheia.org/assets/illustrations/contact-icon-phone@2x.png 2x"
        ...
        <ListItem disableGutters data-aos="fade-up" className={classes.listItem}>
          <ListItemAvatar>
            <Avatar
              src="https://cdn.watheia.org/assets/illustrations/contact-icon-mail.png"
              srcSet="https://cdn.watheia.org/assets/illustrations/contact-icon-mail@2x.png 2x"
              className={classes.icon}
            />
          </ListItemAvatar>
          <ListItemText
        ...
        <ListItem disableGutters data-aos="fade-up" className={classes.listItem}>
          <ListItemAvatar>
            <Avatar
              src="https://cdn.watheia.org/assets/illustrations/contact-icon-pin.png"
              srcSet="https://cdn.watheia.org/assets/illustrations/contact-icon-pin@2x.png 2x"
              className={classes.icon}
            />
          </ListItemAvatar>
          <ListItemText
