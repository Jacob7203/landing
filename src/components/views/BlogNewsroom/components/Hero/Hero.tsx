...
const Hero = ({ className, ...rest }: ViewComponentProps): JSX.Element => {
  ...
  return (
    <div className={clsx(classes.root, className)} {...rest}>
      <Image
        src="https://cdn.watheia.org/assets/photos/about/hero-image.png"
        srcSet="https://cdn.watheia.org/assets/photos/about/hero-image.png 2x"
        alt="About"
              ...
              <OutlinedInput
                startAdornment={
                  <InputAdornment position="start">
                    <Icon fontIconClass="fas fa-search" fontIconColor={colors.blueGrey[900]} />
                  </InputAdornment>
                }
