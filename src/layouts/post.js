          ...
          >
            ...
            >
              {has_image && (
                ...
                >
                  <img
                    src={withPrefix(_.get(this.props, "page.frontmatter.image", null))}
                ...
                <div className="post__meta mb-2">
                  {_.get(this.props, "page.frontmatter.categories", null) && (
                    <React.Fragment>
                      <BlogPostCategories
                        {...this.props}
                        categories={_.get(this.props, "page.frontmatter.categories", null)}
                  ...
                  <span className="post__date">
                    ...
                    >
                      {moment(_.get(this.props, "page.frontmatter.date", null)).strftime(
                        "%B %d, %Y"
                      )}
                    </time>
                  </span>
